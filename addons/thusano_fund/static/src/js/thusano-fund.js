odoo.define('thusano_fund.thusano-fund', function (require) {
'use strict';
var core = require('web.core');
var qweb = core.qweb;
var ajax = require('web.ajax');
ajax.loadXML('/thusano_fund/static/src/xml/thresholds_grant.xml', qweb);
...
//                $modelContainer.append(qweb.render('nyda_grant_and_voucher.DocumentsInspector.resModel', options));
        ...
        if($('#business_ownership_status')){
            $("#addBusinessOwnerStatusRow").on("click", function () {
                ...
                cols += '<select name="position" class="select_style"><option value="">- Select Position -</option><option value="Director">Director</option><option value="Owner/Manager">Owner/Manager</option><option value="Manager">Manager</option><option value="Employee">Employee</option></select>';                
  ...
  var emp_sect = x[currentTab].getElementById("empl_sector");
  var value = emp_sect.options[emp_sect.selectedIndex].value;
  ...
  if(value == "government"){
     		 valid = false;
       			alert("Sorry! Government Employees are not allowed to apply for this Fund.");
   }
