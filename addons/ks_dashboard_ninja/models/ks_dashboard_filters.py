...
class KsDashboardNinjaTemplate(models.Model):
    ...
    display_type = fields.Selection([
        ('line_section', "Separator"),('filter_section', 'Filter section')], default='filter_section',required=True, help="Technical field for UX purpose.")
    ...
    def ks_on_change_display_type(self):
        for rec in self:
            if rec.display_type == 'line_section':
                rec.ks_model_id = False
                rec.ks_domain = False
                rec.ks_is_active = False
