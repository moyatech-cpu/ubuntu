    ...
    var KsDashboardNinja = Widget.extend(ControlPanelMixin, {
        ...
        getContext: function() {
            ...
            var context = {
                ...
                time_format : _t.database.parameters.time_format
            }
...
//            self.ks_fetch_data();
        ...
        events: {
            ...
            'click .chart_xls_export': 'ksChartExportXlsCsv',
...
//            $('#ks_dashboard_title_input').val(this.ks_dashboard_data.ks_child_boards[this.ks_dashboard_data.ks_selected_board_id][0]);
        ...
        start: function() {
            ...
            return this._super().then(function(){
                bus.on('notification', self, function (notifications) {
                    ...
                    _.each(notifications, (function (notification) {
                        if (notification[1].hasOwnProperty('type') && notification[1]['type'] === "ks_dashboard_ninja.notification" && self.ks_mode ==='active') {
                            ...
                            if(item_to_update){
                                ...
                                var msg = "" + item_to_update.length + " Dashboard items has been updated."
                                ...
                                if(update_notification_ids.length>0){
                                    ...
                                    self.do_notify(_t('notification'),
                                         _t(msg)
                                        );
                                }
       ...
       var self = this;
        ...
        renderKpi: function(item, grid) {
            ...
            var item_info = {
                ...
                target_progress_deviation: parseInt(Math.round((count_1 / target_1) * 100)),
                ...
                switch (field.ks_data_comparison) {
                    ...
                    case "Ratio":
                        ...
                        if (item.ks_data_formatting == 'exact'){
                            ...
                            item_info['count'] = field_utils.format.float(count_1 / gcd, Float64Array) + ":" + field_utils.format.float(count_2 / gcd, Float64Array);
                            } else {
