odoo.define('nyda_grant_and_voucher.assessment', function (require) {
'use strict';
...
$(document).ready(function() {
        ...
        $("#selection_threshold").on('click', function(){
            var val = $("#selection_threshold").val();
            console.log('----------->>>val ', val)
            if (val == 'threshold_1'){
                console.log('---->>>threshold1');
                $(".display_working_capital").html("Usage of working capital – maximum R7000,00 ");
                $("#sfield4").removeClass('hidden');
                $("#sfield1").removeClass('hidden');
...
;
            ...
            if (val == 'threshold_2'){
                ...
                $(".display_working_capital").html("Usage of working capital – maximum R5000,00");
                $(".display_additional_jobs").html("Must create at least one permanent additional job.");
            ...
            if (val == 'threshold_3'){
                ...
                $(".display_additional_jobs").html("Must create at least two permanent additional jobs (Must sustain at least 5 permanent jobs for cooperatives).");
                $(".display_working_capital").html("Usage of working capital – maximum R10000,00.");
                $(".display_business_operational").html("The business must be operational for a minimum of two years.");
                $("#sfield3").removeClass('hidden');
                $("#sfield4").removeClass('hidden');
                $("#sfield5").removeClass('hidden');
                $("#sfield6").removeClass('hidden');
                $("#sfield2").removeClass('hidden');
                $("#sfield8").removeClass('hidden');
                $("#sfield9").removeClass('hidden');
        ...
        if($('#job_creation')){
            $("#addJobRow").on("click", function () {
                ...
                cols += '<td style="border-bottom: 3px solid black;"><input type="number" class="form-control numericOnly" name="before_funding_male"/></td>';
                cols += '<td style="border-bottom: 3px solid black; border-right: 1px solid black;"><input type="number" class="form-control numericOnly" name="before_funding_female"/></td>';
        ...
        if($('#job_creation')){
                ...
                $('#job_creation tbody tr').each(function(){
                    ...
                    $('#business_ownership_status tbody tr').each(function(){
                        ...
                        business_ownership_status['position'] = $(this).find('td input[name="position"]').val();
  ...
  for (i = 0; i < z.length; i++) {
       if (z[i].value == "") {
            valid = false;
             alert("Please submit all Mandatory proof");
             break;
      }
  }
