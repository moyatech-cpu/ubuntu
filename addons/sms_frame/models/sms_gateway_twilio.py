...
class SmsGatewayTwilio(models.Model):
    ...
    def delivary_receipt(self, account_sid, message_id):
        ...
        response_string = requests.post("https://api.twilio.com/2010-04-01/Accounts/" + my_account.twilio_account_sid + "/Messages/" + message_id, auth=(str(my_account.twilio_account_sid), str(my_account.twilio_auth_token)))
